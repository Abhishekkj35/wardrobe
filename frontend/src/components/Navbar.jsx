...
import { setShowSearch } from '../../slicers/searchSlice';
      ...
      <div className="flex items-center justify-between py-5 font-median">
         <Link to="./"><h1 className='text-2xl pb-5'><span className='text-4xl'>W</span>ardrobe<span className='text-5xl'>.</span></h1></Link>
          <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
              ...
              <NavLink onClick={()=>dispatch(setShowSearch(false))} to="/collections" className="flex flex-col items-center gap-1">
                  <p>COLLECTION</p>
                  <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden"/>
              </NavLink>
          ...
          <div className='flex items-center gap-6'>
              <img onClick={()=>dispatch(setShowSearch(true))} src={assets.search_icon} className="w-5 cursor-pointer" alt="" />
